...
class TopicRow(Base):
    ...
    source_type: Mapped[str] = mapped_column(String(16), nullable=False, default="topic")
    ...
    active_section_index: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    latest_test_result: Mapped[str | None] = mapped_column(Text, nullable=True)
    weak_section: Mapped[str | None] = mapped_column(String(255), nullable=True)
